class ScrapyConfigsController < ApplicationController
  ...
  #params.require(:scrapy_config).permit(:approved_senders, approved_sender: [])
  ...
  def create
    ...
    @scrapy_config.approved_mail_subjects = scrapy_config_params[:approved_mail_subjects].split(",")
