...
class FileAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_attachment" do
    assert_difference('FileAttachment.count') do
      post file_attachments_url, params: { file_attachment: { scrapy_config_id: @file_attachment.scrapy_config_id, type_of_attachment: @file_attachment.type_of_attachment } }
    end
  ...
  test "should update file_attachment" do
    patch file_attachment_url(@file_attachment), params: { file_attachment: { scrapy_config_id: @file_attachment.scrapy_config_id, type_of_attachment: @file_attachment.type_of_attachment } }
