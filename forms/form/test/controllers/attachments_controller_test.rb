...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { scrapy_config_id: @attachment.scrapy_config_id, type: @attachment.type } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { scrapy_config_id: @attachment.scrapy_config_id, type: @attachment.type } }
